...
import 'package:goan_market/views/orders_screen/components/order_place_details.dart';
import 'package:goan_market/views/orders_screen/components/order_status.dart';
...
class OrdersDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      ...
      appBar: AppBar(
        title: 'Order Details'.text.fontFamily(bold).color(darkFontGrey).make(),
      ),
      body: Padding(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              const Divider(),
              10.heightBox,
              'Order Product'.text.size(16).color(darkFontGrey).fontFamily(bold).makeCentered(),
